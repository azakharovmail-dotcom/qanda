...
// ---------------------------------------------------------------------------
// «Создать событие» — chooser screen of the builder from the owner's Claude
// Design (Есть вопросы.dc.html, data-screen="setup"): event name + activity
// type (Q&A / Опрос free, Квиз / Облако слов PRO). «Запустить» routes to the
// admin panel at /dashboard (same prototype → consistent with the admin view).
// Verbatim markup + the design's _setupBuilder script, adapted into an effect.
// ---------------------------------------------------------------------------
